...
public class MemoryEditorUtil {
    ...
    public static Boolean enableEvent(EventInfo event, MemoryAdapter handler) {
        return toggleEvent(event, handler, true);
    }

    public static Boolean disableEvent(EventInfo event, MemoryAdapter handler) {
        return toggleEvent(event, handler, false);
    }

    private static Boolean toggleEvent(EventInfo event, MemoryAdapter handler, Boolean enable) {
