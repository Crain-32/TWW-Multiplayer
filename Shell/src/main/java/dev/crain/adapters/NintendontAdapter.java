...
import dev.crain.adapters.sockets.NintendontOperation;
import dev.crain.adapters.sockets.NintendontSocket;
...
@Slf4j
@Component
public class NintendontAdapter extends MemoryAdapter {
