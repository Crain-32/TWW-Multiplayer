...
public class DungeonItemHandler extends ItemCategoryHandler {
     ...
     */
    private Boolean giveSmallKey(ItemInfo info) throws FailedToGiveItemException, MemoryHandlerException {
    ...
    private Boolean takeSmallKey(ItemInfo info) throws FailedToTakeItemException, MemoryHandlerException {
        var memoryAdapter = getMemoryAdapter();
        Byte stageId = DungeonStageInfo.stageIdFromItem(info);
        Byte currStageId = memoryAdapter.readByte(MemoryConstants.currStageAddress);
        boolean tookItem;
    ...
    private Boolean toggleDungeonFlag(Byte stageId, Integer offset, Boolean enable) throws MemoryHandlerException {
        var memoryAdapter = getMemoryAdapter();
